...
class LeadManagementController extends Controller
{
    ...
    public function updateStatus(UpdateLeadStatusRequest $request, string $source, int $id): JsonResponse
    {
        ...
        return ApiResponse::success(['status' => $validated['status']], 'Lead status updated successfully.');
    }
    ...
    public function convertLead(ConvertLeadRequest $request, string $source, int $id): JsonResponse
    {
        ...
        return ApiResponse::success(['lead_id' => $leadModel->id, 'status' => 'won'], 'Lead converted successfully.');
    }
    ...
    private function mergedLeads(): Collection
    {
        ...
        return $leads->concat($digital)->concat($webapp)->concat($meta)->concat($google);
    }
