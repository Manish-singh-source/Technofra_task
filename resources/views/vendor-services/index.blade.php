                ...
                <div class="row mb-3">
                    <div class="col-12">
                        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                            <div>
                                <h6 class="mb-0">
                                    Showing <span id="visibleServiceCount">{{ $visibleCount }}</span> vendor service(s)
                            ...
                            <div>
                                @can('delete_seleted_vendor_service')
                    ...
                    <table id="example" data-no-default-datatable="true" class="table table-striped table-bordered align-middle" style="width:100%">
                        ...
                        <tbody>
                            @forelse($services as $service)
                                ...
                                <tr class="{{ $daysLeft <= 5 ? 'table-danger' : '' }}" data-tab-group="{{ $service->tab_key }}">
