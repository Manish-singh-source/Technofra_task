        ...
        <tr>
            <td align="center">
                <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="560"
                    ...
                    <tr>
                        <td style="padding:18px 48px 0 48px;">
                            <h1 style="margin:0; font-size:24px; line-height:1.35; color:#2b3b52; font-weight:700;">
                                Daily Renewal Email Notifications</h1>
                        </td>
                    </tr>
                                ...
                                <tr>
                                    <td style="padding:30px;">
                                        ...
                                        <table role="presentation" cellpadding="0" cellspacing="0" border="0"
                                            width="100%"
                                            style="border:1px solid #d9e3ef; margin-bottom:16px; border-collapse:collapse;">
                                            <tr>
                                                <td colspan="2"
                                                    style="padding:14px 16px; background-color:#f8fafc; border-bottom:1px solid #d9e3ef; font-size:16px; font-weight:700; color:#1e293b;">
                                                    Renewal Summary Overview
                                                </td>
                                            </tr>
                                            <tr>
                                                <td
                                                    style="padding:12px 16px; border-bottom:1px solid #e2e8f0; font-size:14px; font-weight:700; color:#334155; width:42%;">
                                                    Total Renewal Items</td>
                                                <td
                                                    style="padding:12px 16px; border-bottom:1px solid #e2e8f0; font-size:14px; color:#475569;">
                                                    {{ $totalRenewals }}</td>
                                            </tr>
                                            <tr>
                                                <td
                                                    style="padding:12px 16px; border-bottom:1px solid #e2e8f0; font-size:14px; font-weight:700; color:#334155;">
                                                    Client Renewals</td>
                                                <td
                                                    style="padding:12px 16px; border-bottom:1px solid #e2e8f0; font-size:14px; color:#475569;">
                                                    {{ $clientServices->count() }}</td>
                                            </tr>
                                            <tr>
                                                <td
                                                    style="padding:12px 16px; border-bottom:1px solid #e2e8f0; font-size:14px; font-weight:700; color:#334155;">
                                            ...
                                            <tr>
                                                ...
                                                <td
                                                    style="padding:12px 16px; border-bottom:1px solid #e2e8f0; font-size:14px; color:#475569;">
                                                    <a href="{{ url('/client') }}"
                                                        style="color:#004aad; text-decoration:underline;">Open Client
                                                        Renewals</a>
                                                    &nbsp;|&nbsp;
                                                    <a href="{{ url('/vendor-services') }}"
                                                        style="color:#004aad; text-decoration:underline;">Open Vendor
                                                        Renewals</a>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td
                                                    style="padding:12px 16px; font-size:14px; font-weight:700; color:#334155;">
                                                    Generated At</td>
                                            ...
                                            <tr>
                                                ...
                                                <td valign="top" style="padding:0 0 20px 0;">
                                                    <div
                                                        ...
                                                        Review renewal dates</div>
                                                    <div style="font-size:15px; line-height:1.7; color:#64748b;">Check
                                                        all listed client and vendor renewals and prioritize items that
                                                        have already expired or are due today.</div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td valign="top" style="padding:0 20px 20px 0; width:38px;">
                                                ...
                                                <td valign="top" style="padding:0 0 20px 0;">
                                                    <div
                                                        style="font-size:16px; font-weight:700; color:#26384f; margin-bottom:6px;">
                                                        Coordinate renewals</div>
                                                    <div style="font-size:15px; line-height:1.7; color:#64748b;">Reach
                                                        out to the relevant client, vendor, or internal owner so payment
                                                        and continuation steps are completed on time.</div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td valign="top" style="padding:0;">
                                                    <div
                                                        style="font-size:16px; font-weight:700; color:#26384f; margin-bottom:6px;">
                                                        Update the renewal records</div>
                                                    <div style="font-size:15px; line-height:1.7; color:#64748b;">After
                                                        action is taken, update the service status and dates in the
                                                        dashboard so future reminders stay accurate.</div>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                    ...
                    <tr>
                        <td style="padding:40px 48px 0 48px;">
                            ...
                            <div style="font-size:15px; line-height:1.9;">
                                <a href="{{ url('/client') }}" style="color:#004aad; text-decoration:none;">Open
                                    Client Renewals</a>
                                <span style="color:#94a3b8;">&nbsp;|&nbsp;</span>
                                <a href="{{ url('/vendor-services') }}"
                                    style="color:#004aad; text-decoration:none;">Open Vendor Services</a>
                                <span style="color:#94a3b8;">&nbsp;|&nbsp;</span>
